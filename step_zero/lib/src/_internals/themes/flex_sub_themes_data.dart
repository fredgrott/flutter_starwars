...
const FlexSubThemesData appFlexSubThemeData = FlexSubThemesData(
  ...
  interactionEffects: ThemeDataModel.kSubThemeInteractionEffects,
  ...
  defaultRadius: ThemeDataModel.kSubThemeDefaultRadius,
  ...
  inputDecoratorSchemeColor: ThemeDataModel.kSubThemeInputDecorSchemeColor,
  ...
  fabUseShape: ThemeDataModel.kSubThemeFabUseShape,
  ...
  fabSchemeColor: ThemeDataModel.kSubThemeFabSchemeColor,

  // Select the ColorScheme color used by Chips as their base color
  // Primary is default so no need to set that, used here as placeholder to
  // enable easy selection of other options.
  chipSchemeColor: ThemeDataModel.kSubThemeChipSchemeColor,

  // Elevations have easy override values as well.
  elevatedButtonElevation: ThemeDataModel.kSubThemeElevatedButtonWElevation,
  ...
  // toggle buttons.
  thickBorderWidth: ThemeDataModel.kSubThemeThickBorderWidth, // Default is 2.0.
  thinBorderWidth: ThemeDataModel.kSubThemeThinBorderWidth, // Default is 1.5.
  ...
  bottomNavigationBarSelectedLabelSchemeColor:
      ThemeDataModel.kSubThemeBtmNavSelectLableSchemeColor,
  ...
  bottomNavigationBarBackgroundSchemeColor:
      ThemeDataModel.kSubThemeNavBackgroundSchemeColor,

  // SchemeColor based color for [NavigationBar]'s selected item icon.
  navigationBarSelectedIconSchemeColor: ThemeDataModel.kSubThemeNavSelectedIconSchemeColor,

  // SchemeColor based color for [NavigationBar]'s selected item label.
  navigationBarSelectedLabelSchemeColor:
      ThemeDataModel.kSubThemeNavSelectedLabelSchemeColor,

  // SchemeColor based color for [NavigationBar]'s unselected item icons.
  navigationBarUnselectedIconSchemeColor:
      ThemeDataModel.kSubThemeNavUnSelectedIconSchemeColor,

  // SchemeColor based color for [NavigationBar]'s unselected item icons.
  navigationBarUnselectedLabelSchemeColor:
      ThemeDataModel.kSubThemeNavUnSelectedLabelSchemeColor,

  // SchemeColor based color for [NavigationBar]'s selected item highlight.
  navigationBarIndicatorSchemeColor: ThemeDataModel.kSubThemeNavIndicatorSchemeColor,
  ...
  navigationBarBackgroundSchemeColor: ThemeDataModel.kSubThemeNavBackgroundSchemeColor,
  ...
  navigationBarMutedUnselectedIcon: ThemeDataModel.kSubThemeNavMutedUnSelectIcon,
  ...
  navigationBarMutedUnselectedLabel: ThemeDataModel.kSubThemeNavMutedUnSelectLabel,

  // Set size of labels.
  navigationBarSelectedLabelSize: ThemeDataModel.kSubThemeNavSelectLabelSize,
  navigationBarUnselectedLabelSize: ThemeDataModel.kSubThemeNavUnSelectLabelSize,
  // Set the size of icons icons.
  navigationBarSelectedIconSize: ThemeDataModel.kSubThemeNavSelectIconSize,
  navigationBarUnselectedIconSize: ThemeDataModel.kSubThemeNavUnSelectIconSize,
);
