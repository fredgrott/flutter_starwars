...
/// FlexKeyColors for the FlexColorScheme way of filling the gaps in
/// Material Themes.
/// 
/// @author Fredrick Allan Grott
const FlexKeyColors appFlexKeyColors = FlexKeyColors(
  useTertiary: ThemeDataModel.kFlexKeyColorsUseTertiary,
  useSecondary: ThemeDataModel.kFlexKeyColorsUseSecondary,
  keepPrimary: ThemeDataModel.kFlexKeyColorsKeepPrimary,
  keepPrimaryContainer: ThemeDataModel.kFlexKeyColorsKeepPrimaryContainer,
  keepSecondary: ThemeDataModel.kFlexKeyColorsKeepSecondary,
  keepSecondaryContainer: ThemeDataModel.kFlexKeyColorsKeepSecondaryContainer,
  keepTertiary: ThemeDataModel.kFlexKeyColorsKeepTertiary,
  keepTertiaryContainer: ThemeDataModel.kFlexKeyColorsKeepTertiaryContainer,
);
