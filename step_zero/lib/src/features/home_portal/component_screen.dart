      ...
      child: Column(
        ...
        children: <Widget>[
          ElevatedButton(
            ...
            child: Text(
              "Elevated",
              style: !isDisabled? Theme.of(context).textTheme.labelMedium?.copyWith(
  ...
  void openDialog(BuildContext context) {
    showDialog<void>(
        ...
        builder: (context) => LifecycleWrapper(
              ...
              // Workaround for MD3 support to get elevation, sshadow, and surfaceTintColor
              child: Material(
                elevation: Theme.of(context).dialogTheme.elevation ?? 6.0,
